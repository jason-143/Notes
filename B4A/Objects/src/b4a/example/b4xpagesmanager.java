...
__c.LogImpl("912582915",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("912451861","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("912845060","Only top page can be closed",0);
...
__c.LogImpl("912845063","First page cannot be closed",0);
...
__c.LogImpl("913500419","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("913500420","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("912386331","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
